...
- In the testcases generated by me, I have used one Physical device and one emualator for testing. 
  ...
  | CPU 				| MEMORY 			  	| NETWORK 				|
|:-----------------:|:---------------------:|:-----------------:|
| ![cpu1](Performance Memory and CPU/cpu_register.png) | ![memory1](/Performance Memory and CPU/memory usage_register.png) 	| ![network1](/Performance Memory and CPU/network stats at installation and startup.png) 	|
